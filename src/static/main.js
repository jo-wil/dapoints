...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{email: '', password: '', user: $elm$core$Maybe$Nothing},
...
var $author$project$Main$User = F3(
	function (name, email, jwt) {
		return {email: email, jwt: jwt, name: name};
	});
					...
					$elm$http$Http$post(
						{
							...
							expect: A2($elm$http$Http$expectJson, $author$project$Main$OnLogin, $author$project$Main$userDecoder),
							url: '/login'
						}));
			default:
				var result = msg.a;
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput($author$project$Main$Email)
					]),
				_List_Nil),
				A2(
				$elm$html$Html$input,
...
var $author$project$Main$view = function (model) {
	...
	if (_v0.$ === 'Just') {
		var user = _v0.a;
		return $elm$html$Html$text(user.email);
	} else {
